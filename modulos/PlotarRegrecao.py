...
def plotResul(x, y, total, novo_x=0, novo_y=0,
    ...
    if replot == 'n':
        R2_1 = grau(x,y, 1,'#FFD700', 'Grau 1')
        R2_2 = grau(x,y, 2,'red', 'Grau 2')
        R2_3 = grau(x,y, 3, 'blue', 'Grau 3')
        R2_4 = grau(x,y, 4, 'black', 'Grau 4')
    
    else:
        R2_1 = grau(novo_x, novo_y, 1,'#FFD700', 'Grau 2')
        R2_3 = grau(novo_x, novo_y, 2,'red', f'Grau 2')
        R2_2 = grau(novo_x, novo_y, 3,'blue', f'Grau 2')
        R2_4 = grau(novo_x, novo_y, 4, 'black', f'Grau 4') 
